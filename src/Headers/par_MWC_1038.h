/*
    ...
    This file (par_MWC_1038.h) is part of GLU.
...
/**
   @file par_MWC_1038.h
   @brief parallel multiply with carry generator of Marsaglia
 */
#ifndef GLU_PAR_MWC_1038
#define GLU_PAR_MWC_1038

/**
   @fn void free_par_MWC_1038( void )
...
/**
   @fn void GLU_set_par_MWC_1038_table( const uint32_t seed[ Latt.Nthreads ] )
...
/**
   @fn double par_MWC_1038_dbl( const uint32_t thread )
...
/**
   @fn int read_par_MWC_1038_table( FILE *rng_file )
...
/**
   @fn void write_par_MWC_1038_table( FILE *rng_file )
